...
/* synthetic */ class PluginController$pluginMethods$5 extends j implements p<MethodCall, MethodChannel.Result, q> {
    PluginController$pluginMethods$5(Object obj) {
    ...
    public final void invoke(MethodCall methodCall, MethodChannel.Result result) {
        k.e(methodCall, "p0");
        k.e(result, "p1");
        ((PluginController) this.receiver).clearGattCache(methodCall, result);
    }
}
