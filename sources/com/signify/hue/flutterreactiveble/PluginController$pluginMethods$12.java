...
/* synthetic */ class PluginController$pluginMethods$12 extends j implements p<MethodCall, MethodChannel.Result, q> {
    PluginController$pluginMethods$12(Object obj) {
    ...
    public final void invoke(MethodCall methodCall, MethodChannel.Result result) {
        k.e(methodCall, "p0");
        k.e(result, "p1");
        ((PluginController) this.receiver).negotiateMtuSize(methodCall, result);
    }
}
