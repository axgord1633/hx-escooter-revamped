...
/* synthetic */ class PluginController$writeCharacteristicWithResponse$1 extends j implements s<BleClient, String, UUID, Integer, byte[], r<CharOperationResult>> {
    ...
    public final r<CharOperationResult> invoke(BleClient bleClient, String str, UUID uuid, int i5, byte[] bArr) {
        ...
        k.e(uuid, "p2");
        k.e(bArr, "p4");
        return bleClient.writeCharacteristicWithResponse(str, uuid, i5, bArr);
    }
}
