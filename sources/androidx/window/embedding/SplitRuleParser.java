...
public final class SplitRuleParser {
    private final ComponentName buildClassName(String str, CharSequence charSequence) {
        if (charSequence != null) {
            if (!(charSequence.length() == 0)) {
                ...
                int z4 = n.z(obj, '/', 0, false, 6, (Object) null);
                if (z4 > 0) {
                ...
                if (k.a(obj, "*") || n.z(obj, '.', 0, false, 6, (Object) null) >= 0) {
    ...
    private final ActivityRule parseSplitActivityRule(Context context, XmlResourceParser xmlResourceParser) {
        return new ActivityRule(j0.b(), context.getTheme().obtainStyledAttributes(xmlResourceParser, R.styleable.ActivityRule, 0, 0).getBoolean(R.styleable.ActivityRule_alwaysExpand, false));
    }
    ...
    private final SplitPairRule parseSplitPairRule(Context context, XmlResourceParser xmlResourceParser) {
        ...
        float f5 = obtainStyledAttributes.getFloat(R.styleable.SplitPairRule_splitRatio, CropImageView.DEFAULT_ASPECT_RATIO);
        int dimension = (int) obtainStyledAttributes.getDimension(R.styleable.SplitPairRule_splitMinWidth, CropImageView.DEFAULT_ASPECT_RATIO);
        int dimension2 = (int) obtainStyledAttributes.getDimension(R.styleable.SplitPairRule_splitMinSmallestWidth, CropImageView.DEFAULT_ASPECT_RATIO);
        int i5 = obtainStyledAttributes.getInt(R.styleable.SplitPairRule_splitLayoutDirection, 3);
        return new SplitPairRule(j0.b(), obtainStyledAttributes.getBoolean(R.styleable.SplitPairRule_finishPrimaryWithSecondary, false), obtainStyledAttributes.getBoolean(R.styleable.SplitPairRule_finishSecondaryWithPrimary, true), obtainStyledAttributes.getBoolean(R.styleable.SplitPairRule_clearTop, false), dimension, dimension2, f5, i5);
    }
    ...
    private final SplitPlaceholderRule parseSplitPlaceholderRule(Context context, XmlResourceParser xmlResourceParser) {
        ...
        float f5 = obtainStyledAttributes.getFloat(R.styleable.SplitPlaceholderRule_splitRatio, CropImageView.DEFAULT_ASPECT_RATIO);
        int dimension = (int) obtainStyledAttributes.getDimension(R.styleable.SplitPlaceholderRule_splitMinWidth, CropImageView.DEFAULT_ASPECT_RATIO);
        int dimension2 = (int) obtainStyledAttributes.getDimension(R.styleable.SplitPlaceholderRule_splitMinSmallestWidth, CropImageView.DEFAULT_ASPECT_RATIO);
        ...
        return new SplitPlaceholderRule(b5, component, dimension, dimension2, f5, i5);
    }
    ...
    private final java.util.Set<androidx.window.embedding.EmbeddingRule> parseSplitXml(android.content.Context r9, int r10) {
        /*
            ...
            kotlin.jvm.internal.k.d(r10, r0)     // Catch:{ NotFoundException -> 0x00ec }
        ...
        L_0x002a:
            ...
            boolean r3 = kotlin.jvm.internal.k.a(r7, r3)
