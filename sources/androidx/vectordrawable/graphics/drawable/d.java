...
public class d {
    ...
    private static class a implements TypeEvaluator<c.b[]> {
        ...
        /* renamed from: a */
        public c.b[] evaluate(float f5, c.b[] bVarArr, c.b[] bVarArr2) {
            if (c.b(bVarArr, bVarArr2)) {
                if (!c.b(this.f2738a, bVarArr)) {
                    this.f2738a = c.f(bVarArr);
                }
                for (int i5 = 0; i5 < bVarArr.length; i5++) {
                    this.f2738a[i5].d(bVarArr[i5], bVarArr2[i5], f5);
                }
                return this.f2738a;
            }
    ...
    private static Animator a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, float f5) {
        return b(context, resources, theme, xmlPullParser, Xml.asAttributeSet(xmlPullParser), (AnimatorSet) null, 0, f5);
    }
    ...
    private static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) {
        ...
        L_0x005d:
            ...
            r15.<init>()
            int[] r0 = androidx.vectordrawable.graphics.drawable.a.f2720h
            r7 = r22
            android.content.res.TypedArray r6 = androidx.core.content.res.l.k(r8, r9, r7, r0)
            java.lang.String r0 = "ordering"
            int r16 = androidx.core.content.res.l.g(r6, r10, r0, r14, r14)
            r0 = r18
            r1 = r19
            r2 = r20
            r3 = r21
    ...
    private static android.animation.PropertyValuesHolder e(android.content.res.TypedArray r11, int r12, int r13, int r14, java.lang.String r15) {
        ...
        L_0x003c:
            ...
            androidx.core.graphics.c$b[] r13 = androidx.core.graphics.c.d(r12)
            androidx.core.graphics.c$b[] r14 = androidx.core.graphics.c.d(r11)
        ...
        L_0x0054:
            ...
            boolean r3 = androidx.core.graphics.c.b(r13, r14)
    ...
    private static int f(TypedArray typedArray, int i5, int i6) {
        ...
        return ((!z5 || !h(i7)) && (!z4 || !h(z4 ? peekValue2.type : 0))) ? 0 : 3;
    }

    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray k5 = l.k(resources, theme, attributeSet, a.f2722j);
        int i5 = 0;
        TypedValue l5 = l.l(k5, xmlPullParser, "value", 0);
        if ((l5 != null) && h(l5.type)) {
            i5 = 3;
        }
        k5.recycle();
        return i5;
    ...
    public static Animator k(Context context, Resources resources, Resources.Theme theme, int i5, float f5) {
        XmlResourceParser xmlResourceParser = null;
        try {
            XmlResourceParser animation = resources.getAnimation(i5);
            Animator a5 = a(context, resources, theme, animation, f5);
            if (animation != null) {
                animation.close();
            }
            return a5;
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f5, XmlPullParser xmlPullParser) {
        TypedArray k5 = l.k(resources, theme, attributeSet, a.f2719g);
        TypedArray k6 = l.k(resources, theme, attributeSet, a.f2723k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, k5, k6, f5, xmlPullParser);
        int h5 = l.h(k5, xmlPullParser, "interpolator", 0, 0);
        if (h5 > 0) {
            valueAnimator.setInterpolator(c.a(context, h5));
        }
        k5.recycle();
        if (k6 != null) {
            k6.recycle();
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i5, XmlPullParser xmlPullParser) {
        TypedArray k5 = l.k(resources, theme, attributeSet, a.f2722j);
        float f5 = l.f(k5, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue l5 = l.l(k5, xmlPullParser, "value", 0);
        boolean z4 = l5 != null;
        if (i5 == 4) {
            i5 = (!z4 || !h(l5.type)) ? 0 : 3;
        }
        Keyframe ofInt = z4 ? i5 != 0 ? (i5 == 1 || i5 == 3) ? Keyframe.ofInt(f5, l.g(k5, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(f5, l.f(k5, xmlPullParser, "value", 0, CropImageView.DEFAULT_ASPECT_RATIO)) : i5 == 0 ? Keyframe.ofFloat(f5) : Keyframe.ofInt(f5);
        int h5 = l.h(k5, xmlPullParser, "interpolator", 1, 0);
        if (h5 > 0) {
            ofInt.setInterpolator(c.a(context, h5));
        }
        k5.recycle();
        return ofInt;
    }
    ...
    private static android.animation.PropertyValuesHolder[] p(android.content.Context r17, android.content.res.Resources r18, android.content.res.Resources.Theme r19, org.xmlpull.v1.XmlPullParser r20, android.util.AttributeSet r21) {
        ...
        L_0x0016:
            ...
            int[] r0 = androidx.vectordrawable.graphics.drawable.a.f2721i
            r11 = r18
            r12 = r19
            r13 = r21
            android.content.res.TypedArray r14 = androidx.core.content.res.l.k(r11, r12, r13, r0)
            java.lang.String r0 = "propertyName"
            java.lang.String r15 = androidx.core.content.res.l.i(r14, r6, r0, r1)
            r0 = 4
            java.lang.String r1 = "valueType"
            int r5 = androidx.core.content.res.l.g(r14, r6, r1, r2, r0)
            r0 = r17
            r1 = r18
            r2 = r19
            r3 = r20
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f5, XmlPullParser xmlPullParser) {
        long g5 = (long) l.g(typedArray, xmlPullParser, "duration", 1, 300);
        long g6 = (long) l.g(typedArray, xmlPullParser, "startOffset", 2, 0);
        int g7 = l.g(typedArray, xmlPullParser, "valueType", 7, 4);
        if (l.j(xmlPullParser, "valueFrom") && l.j(xmlPullParser, "valueTo")) {
            if (g7 == 4) {
                g7 = f(typedArray, 5, 6);
            }
            PropertyValuesHolder e5 = e(typedArray, g7, 5, 6, BuildConfig.FLAVOR);
            if (e5 != null) {
                valueAnimator.setValues(new PropertyValuesHolder[]{e5});
            }
        }
        valueAnimator.setDuration(g5);
        valueAnimator.setStartDelay(g6);
        valueAnimator.setRepeatCount(l.g(typedArray, xmlPullParser, "repeatCount", 3, 0));
        valueAnimator.setRepeatMode(l.g(typedArray, xmlPullParser, "repeatMode", 4, 1));
        if (typedArray2 != null) {
            r(valueAnimator, typedArray2, g7, f5, xmlPullParser);
        }
    }

    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i5, float f5, XmlPullParser xmlPullParser) {
        ObjectAnimator objectAnimator = (ObjectAnimator) valueAnimator;
        String i6 = l.i(typedArray, xmlPullParser, "pathData", 1);
        if (i6 != null) {
            String i7 = l.i(typedArray, xmlPullParser, "propertyXName", 2);
            String i8 = l.i(typedArray, xmlPullParser, "propertyYName", 3);
            if (i5 != 2) {
            }
            if (i7 == null && i8 == null) {
                throw new InflateException(typedArray.getPositionDescription() + " propertyXName or propertyYName is needed for PathData");
            }
            s(c.e(i6), objectAnimator, f5 * 0.5f, i7, i8);
            return;
        }
        objectAnimator.setPropertyName(l.i(typedArray, xmlPullParser, "propertyName", 0));
    }
