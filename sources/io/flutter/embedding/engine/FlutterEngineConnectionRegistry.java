...
class FlutterEngineConnectionRegistry implements PluginRegistry, ActivityControlSurface, ServiceControlSurface, BroadcastReceiverControlSurface, ContentProviderControlSurface {
    ...
    private static class FlutterEngineActivityPluginBinding implements ActivityPluginBinding {
        ...
        public FlutterEngineActivityPluginBinding(Activity activity2, f fVar) {
        ...
        public void onWindowFocusChanged(boolean z4) {
            for (PluginRegistry.WindowFocusChangedListener onWindowFocusChanged : this.onWindowFocusChangedListeners) {
                onWindowFocusChanged.onWindowFocusChanged(z4);
            }
        }
    ...
    private static class FlutterEngineServicePluginBinding implements ServicePluginBinding {
        ...
        FlutterEngineServicePluginBinding(Service service2, f fVar) {
    ...
    public void attachToBroadcastReceiver(BroadcastReceiver broadcastReceiver2, f fVar) {
    ...
    public void attachToContentProvider(ContentProvider contentProvider2, f fVar) {
    ...
    public void attachToService(Service service2, f fVar, boolean z4) {
        TraceSection.begin("FlutterEngineConnectionRegistry#attachToService");
        try {
            detachFromAppComponent();
            this.service = service2;
            this.servicePluginBinding = new FlutterEngineServicePluginBinding(service2, fVar);
    ...
    public boolean onActivityResult(int i5, int i6, Intent intent) {
        if (isAttachedToActivity()) {
            ...
            try {
                return this.activityPluginBinding.onActivityResult(i5, i6, intent);
            } finally {
                TraceSection.end();
            }
        } else {
    ...
    public boolean onRequestPermissionsResult(int i5, String[] strArr, int[] iArr) {
        if (isAttachedToActivity()) {
            ...
            try {
                return this.activityPluginBinding.onRequestPermissionsResult(i5, strArr, iArr);
            } finally {
                TraceSection.end();
            }
        } else {
