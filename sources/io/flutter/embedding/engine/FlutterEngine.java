...
public class FlutterEngine implements ViewUtils.DisplayUpdater {
    ...
    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI2, PlatformViewsController platformViewsController2, String[] strArr, boolean z4) {
        this(context, flutterLoader, flutterJNI2, platformViewsController2, strArr, z4, false);
    }

    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI2, PlatformViewsController platformViewsController2, String[] strArr, boolean z4, boolean z5) {
        this(context, flutterLoader, flutterJNI2, platformViewsController2, strArr, z4, z5, (FlutterEngineGroup) null);
    }

    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI2, PlatformViewsController platformViewsController2, String[] strArr, boolean z4, boolean z5, FlutterEngineGroup flutterEngineGroup) {
        ...
        this.restorationChannel = new RestorationChannel(dartExecutor2, z5);
    ...
    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI2, String[] strArr, boolean z4) {
        this(context, flutterLoader, flutterJNI2, new PlatformViewsController(), strArr, z4);
    }
    ...
    public FlutterEngine(Context context, String[] strArr, boolean z4) {
        this(context, (FlutterLoader) null, (FlutterJNI) null, strArr, z4);
    }

    public FlutterEngine(Context context, String[] strArr, boolean z4, boolean z5) {
        this(context, (FlutterLoader) null, (FlutterJNI) null, new PlatformViewsController(), strArr, z4, z5);
    }
    ...
    public FlutterEngine spawn(Context context, DartExecutor.DartEntrypoint dartEntrypoint, String str, List<String> list, PlatformViewsController platformViewsController2, boolean z4, boolean z5) {
        DartExecutor.DartEntrypoint dartEntrypoint2 = dartEntrypoint;
        if (isAttachedToJni()) {
            String str2 = str;
            return new FlutterEngine(context, (FlutterLoader) null, this.flutterJNI.spawn(dartEntrypoint2.dartEntrypointFunctionName, dartEntrypoint2.dartEntrypointLibrary, str, list), platformViewsController2, (String[]) null, z4, z5);
        }
